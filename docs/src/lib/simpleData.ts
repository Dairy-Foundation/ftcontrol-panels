    ...
    "changelog": [
      ...
      },
      {
        ...
        "changes": [
          {
            "type": "docs",
            "description": "Added warning for people that don't read entire install guide",
            "upgrading": ""
          },
          {
            "type": "other",
    ...
    "changelog": [
      ...
      },
      {
        ...
        "changes": [
          {
            "type": "deprecated",
            "description": "Moved common docs components for Panels and Docs Website to ftc-panels-docs",
      ...
      },
      {
        ...
        "changes": [
          {
            "type": "added",
            "description": "Added generic functions to fetch latest versions from GitHub hosted mavens",
            "upgrading": ""
          }
        ]
      },
      {
        ...
        "changes": [
          {
            "type": "fixed",
            "description": "Fixed docs handling of URL special characters for selected link",
            "upgrading": ""
          },
          {
            "type": "fixed",
